                ...
                <div className="lg:flex hidden gap-x-14">
                  ...
                  <div>
                    <motion.a
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.5, duration: 0.2 }}
                      className="bg flex items-center font-semibold uppercase text-white transition-all duration-200 shadow-[3px_3px_0px_#000] h-10 px-14 hover:shadow-none rounded"
                    >
                      Login
                    </motion.a>
                  </div>
