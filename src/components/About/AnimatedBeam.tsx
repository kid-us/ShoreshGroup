...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  return (
    <svg
      ...
      className={cn(
        "pointer-events-none absolute left-0 top-0 transform-gpu stroke-1",
        className
      )}
...
>(({ className, children }, ref) => {
  return (
    <motion.div
      ...
      ref={ref}
      className={cn(
        "z-10 flex items-center justify-center border border-btn rounded-xl w-96 p-5 shadow  hover:shadow-btn hover:shadow-lg transition-colors text-black bg-secondary",
        className
      )}
    >
      <div>{children}</div>
