import { Bath, BedDouble, CarFront, Crop, Tag } from "lucide-react";
    ...
    <>
      {asset && (
        <div>
          ...
          {asset.desc2 && <p className="mb-2">{asset.desc2}</p>}
          {asset.desc3 && <p className="mb-2">{asset.desc3}</p>}
          {asset.desc4 && <p className="mb-2">{asset.desc4}</p>}
          {asset.desc5 && <p className="mb-2">{asset.desc5}</p>}
